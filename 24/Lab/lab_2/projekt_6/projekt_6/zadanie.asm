...
_main PROC
	...
	; Wyœwietlenie komunikatu o wprowadzeniu tekstu MessageBoxA
	push	0														; MB_OK
	push	OFFSET tytul											; tytu³ okna
	push	OFFSET magazyn											; tekst do wyœwietlenia
	push	0														; NULL
	call	_MessageBoxA@16											; wywo³anie MessageBoxA

	add		esp,16													; oczyszczenie stosu

	; Zamiana kodów na wielkie litery
	mov		eax,liczba_znakow										; wczytanie liczby znaków do EAX
