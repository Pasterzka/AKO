...
; Uruchomienie w trybie rzeczywistym procesora x86 lub na maszynie wirtualnej
...
obsluga_zegara  PROC
    ...
    ; wpisanie adresu pamięci ekranu do rejestru ES - pamięć ekranu dla trybu tekstowego zaczyna się od adresu B8000H,
    ; jednak do rejestru ES wpisujemy wartość B800H, bo w trakcie obliczenia adresu procesor każdorazowo mnoży zawartość rejestru ES przez 16
    mov     ax, 0B800h
    mov     es, ax
    ...
    mov     byte PTR es:[bx+1], 00000111B   ; kolor (biały na czarnym tle)
